...
def transaction(buyer, seller, buyer_wants, seller_wants, amount_of_product, amount_of_money):
    """This function makes a buyer and seller agent perform a transaction with each other"""
    buyer.transact(buyer_wants, amount_of_product, seller_wants, amount_of_money)
    seller.transact(seller_wants, amount_of_money, buyer_wants, amount_of_product)
