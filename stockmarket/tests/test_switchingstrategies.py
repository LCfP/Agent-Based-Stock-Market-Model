...
def test_adaptive_switching(agents):
    ...
    assert_equal(adaptive_switching(agent=agents[0], conservativeness=0.3, realised_returns=0.04,
    ...
    assert_equal(adaptive_switching(agent=agents[1], conservativeness=0.3, realised_returns=0.04,
    ...
    assert_equal(adaptive_switching(agent=agents[0], conservativeness=2, realised_returns=0,
